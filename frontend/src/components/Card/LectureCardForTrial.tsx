        ...
        <div
            ...
            onClick={() => {
                if (props.handleShowVideoDialog) {
                    props.handleShowVideoDialog(props.lecture.content.url_video, props.lecture.content.description);
                }
...
export default LectureCardForTrial;
