const error = {
    ...
    ERROR_MAX_DISCOUNT_REQUIRED: "Phải nhập giá giảm tối đa",
    ERROR_MAX_DISCOUNT_MIN: "Gía giảm tối đa phải trên 0",
    ERROR_MAX_DISCOUNT_POSITIVE: "Gía giảm tối đa phải là giá trị dương",
    ERROR_CODE_MAX: "Mã phải dưới 30 ký tự",
    ERROR_CODE_MIN: "Mã phải trên 8 ký tự",
    ERROR_DISCOUNT_MAX: "Mức giảm giá phải dưới 100",
    ERROR_DISCOUNT_MIN: "Mức giảm giá phải trên 0",
    ERROR_REMAIN_POSITIVE: "Số lượng còn lại phải là số dương",
    ...
    ERROR_DESCRIPTION_EVENT_MAX: "Mô tả phải dưới 500 ký tự",
