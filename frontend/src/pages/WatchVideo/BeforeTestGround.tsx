...
const BeforeTestGround: React.FC = () => {
    ...
    return (
        <>
            <div className="w-full h-[700px] flex flex-col items-center justify-center bg-white border-gray-400 border round">
                        ...
                        {!is_time_limit ? (
                            <>
                                <span className="text-black shrink-0 text-lg italic">
                                    Đây là bài kiểm tra <span className="text-success">không giới hạn</span> thời gian,
                                    phía trên chỉ là thời gian hoàn thành lý tưởng
                                </span>
                            </>
                        ) : (
                            <>
